...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c18 = /^[^\/{}[\]<>= ,\^_.!]/,
      peg$c19 = peg$classExpectation(["/", "{", "}", "[", "]", "<", ">", "=", " ", ",", "^", "_", ".", "!"], true, false),
      peg$c20 = "\"",
      ...
      peg$c46 = function(field, operator, value) {
            return {
              type: 'where',
              field: field,
              value: value,
      ...
      peg$c61 = function() { return parseFloat(text()); },
      peg$c62 = /^[eE]/,
      ...
      peg$c83 = function(orderSymbol, field) {
            return {
                type: 'order',
  ...
  function peg$parsePathComponent() {
    ...
    if (s1 === peg$FAILED) {
      s1 = peg$parseLiteral();
      if (s1 === peg$FAILED) {
        s1 = peg$parseCollectionExpression();
        if (s1 === peg$FAILED) {
          s1 = peg$parseDocumentExpression();
        }
      }
    }
    if (s1 !== peg$FAILED) {
  ...
  function peg$parseDocumentExpression() {
    var s0, s1, s2, s3, s4, s5;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = [];
        s4 = peg$parseDocumentExpressionComponent();
        if (s4 !== peg$FAILED) {
          while (s4 !== peg$FAILED) {
            s3.push(s4);
            s4 = peg$parseDocumentExpressionComponent();
  ...
  function peg$parseDocumentExpressionComponent() {
    var s0, s1, s2, s3, s4;
  ...
  function peg$parseCollectionExpression() {
    var s0, s1, s2, s3, s4, s5;
